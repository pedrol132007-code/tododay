...
// Ícones de linha no estilo do site da Benner (traço fino, cantos arredondados). Herdam a cor
// do texto (currentColor) e são decorativos: o botão que os usa leva o aria-label.
